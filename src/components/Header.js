...
export default function Header() {
  ...
  return (
    <header className="w-full bg-white border-b border-slate-100 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 sm:h-20 flex items-center gap-2 sm:gap-6">
      ...
      {/* Dedicated translate bar — full width, own row, never squeezed on any screen size */}
      <div className="w-full border-t border-slate-100 bg-blue-50/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-1.5 flex items-center gap-2">
          ...
          <span className="text-xs font-semibold text-blue-700 whitespace-nowrap">Select Language:</span>
