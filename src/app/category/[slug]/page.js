  ...
  return (
    <main>
      ...
      <div className="max-w-7xl mx-auto px-6 py-10">
        <h1 className="text-2xl font-bold text-slate-900 mb-6 capitalize">{params.slug} Books</h1>
        ...
        {books.length === 0 && (
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <p className="text-slate-500 font-medium mb-1">No books here yet</p>
            <p className="text-slate-400 text-sm">Check back soon — new titles are added regularly.</p>
          </div>
        )}
